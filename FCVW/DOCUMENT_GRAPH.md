...
- [`FCVW/AI.md`](AI.md)
- [`FCVW/APP_RULES.md`](APP_RULES.md)
- [`FCVW/APPLICATION_DOCUMENTATION.md`](APPLICATION_DOCUMENTATION.md)
...
- [`FCVW/RETROACTIVE_INSTANTIATION.md`](RETROACTIVE_INSTANTIATION.md)
...
- [`FCVW/briefings/README.md`](briefings/README.md)

## FCVW/changelogs/unreleased

- [`FCVW/changelogs/unreleased/README.md`](changelogs/unreleased/README.md)

## FCVW/decisions

- [`FCVW/decisions/ADR-0001-pure-markdown-over-automation-scripts.md`](decisions/ADR-0001-pure-markdown-over-automation-scripts.md)
...
- [`FCVW/governance/TEMPLATE_AI_RESOURCE.md`](governance/TEMPLATE_AI_RESOURCE.md)
- [`FCVW/governance/TEMPLATE_AI_SESSION_SYNTHESIS.md`](governance/TEMPLATE_AI_SESSION_SYNTHESIS.md)
- [`FCVW/governance/TEMPLATE_API_SPEC.md`](governance/TEMPLATE_API_SPEC.md)
- [`FCVW/governance/TEMPLATE_APP_DOCS_README.md`](governance/TEMPLATE_APP_DOCS_README.md)
...
- [`FCVW/governance/TEMPLATE_FLOW_DOCUMENTATION.md`](governance/TEMPLATE_FLOW_DOCUMENTATION.md)
...
- [`FCVW/governance/TEMPLATE_REFACTORING_DEPENDENCY_MAP.md`](governance/TEMPLATE_REFACTORING_DEPENDENCY_MAP.md)
- [`FCVW/governance/TEMPLATE_REFACTORING_INCREMENTAL_PLAN.md`](governance/TEMPLATE_REFACTORING_INCREMENTAL_PLAN.md)
- [`FCVW/governance/TEMPLATE_REFACTORING_MODULE_INVENTORY.md`](governance/TEMPLATE_REFACTORING_MODULE_INVENTORY.md)
- [`FCVW/governance/TEMPLATE_REFACTORING_OPENING.md`](governance/TEMPLATE_REFACTORING_OPENING.md)
- [`FCVW/governance/TEMPLATE_REFACTORING_POST_VALIDATION_REPORT.md`](governance/TEMPLATE_REFACTORING_POST_VALIDATION_REPORT.md)
...
- [`FCVW/Plans/README.md`](Plans/README.md)
...
- [`FCVW/refactoring-guide/11-refactoring-risk-matrix.md`](refactoring-guide/11-refactoring-risk-matrix.md)
- [`FCVW/refactoring-guide/12-testing-strategy-before-refactoring.md`](refactoring-guide/12-testing-strategy-before-refactoring.md)
- [`FCVW/refactoring-guide/13-ci-cd-pipeline-and-quality-gates.md`](refactoring-guide/13-ci-cd-pipeline-and-quality-gates.md)
- [`FCVW/refactoring-guide/14-rollback-plan.md`](refactoring-guide/14-rollback-plan.md)
- [`FCVW/refactoring-guide/15-incremental-refactoring-plan.md`](refactoring-guide/15-incremental-refactoring-plan.md)
- [`FCVW/refactoring-guide/16-dependency-and-impact-map.md`](refactoring-guide/16-dependency-and-impact-map.md)
- [`FCVW/refactoring-guide/17-branch-and-pull-request-policy.md`](refactoring-guide/17-branch-and-pull-request-policy.md)
- [`FCVW/refactoring-guide/18-behavioral-refactoring-vs-rewrite.md`](refactoring-guide/18-behavioral-refactoring-vs-rewrite.md)
- [`FCVW/refactoring-guide/19-stopping-criteria.md`](refactoring-guide/19-stopping-criteria.md)
- [`FCVW/refactoring-guide/20-templates.md`](refactoring-guide/20-templates.md)
- [`FCVW/refactoring-guide/MANIFEST.md`](refactoring-guide/MANIFEST.md)
- [`FCVW/refactoring-guide/README.md`](refactoring-guide/README.md)

## FCVW/skills

- [`FCVW/skills/README.md`](skills/README.md)

## FCVW/skills/agent-aegis

- [`FCVW/skills/agent-aegis/SKILL.md`](skills/agent-aegis/SKILL.md)

## FCVW/skills/agent-factory

- [`FCVW/skills/agent-factory/SKILL.md`](skills/agent-factory/SKILL.md)

## FCVW/skills/agent-hephaestus

- [`FCVW/skills/agent-hephaestus/SKILL.md`](skills/agent-hephaestus/SKILL.md)

## FCVW/skills/agent-hermes
...
## FCVW/skills/brainstorming-and-tdd

- [`FCVW/skills/brainstorming-and-tdd/SKILL.md`](skills/brainstorming-and-tdd/SKILL.md)

## FCVW/skills/code-hygiene-refactor

- [`FCVW/skills/code-hygiene-refactor/SKILL.md`](skills/code-hygiene-refactor/SKILL.md)

## FCVW/skills/git-conventional-commits

- [`FCVW/skills/git-conventional-commits/SKILL.md`](skills/git-conventional-commits/SKILL.md)
...
- [`FCVW/skills/obsidian-markdown/SKILL.md`](skills/obsidian-markdown/SKILL.md)

## FCVW/skills/orchestrator

- [`FCVW/skills/orchestrator/SKILL.md`](skills/orchestrator/SKILL.md)
...
## FCVW/skills/retroactive-instantiation

- [`FCVW/skills/retroactive-instantiation/SKILL.md`](skills/retroactive-instantiation/SKILL.md)

## FCVW/skills/self-improvement

- [`FCVW/skills/self-improvement/SKILL.md`](skills/self-improvement/SKILL.md)

## FCVW/skills/systematic-debugging

- [`FCVW/skills/systematic-debugging/SKILL.md`](skills/systematic-debugging/SKILL.md)
